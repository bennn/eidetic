...
for BM in combinations trie-vector jpeg synth-worst suffixtree-worst acquire-worst array dungeon-worst forth-bad forth-worst fsm-bad fsm-worst-case graph gregor-worst hanoi lnm-worst mbta-worst morsecode-worst quadBG-worst quadMB-bad quadMB-worst snake-worst take5-worst tetris-worst trie zombie-worst zordoz-worst; do
  cd ${BM} && \
