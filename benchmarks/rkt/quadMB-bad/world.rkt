...
(: quality-default (Parameterof Index))
...
(: leading-key QuadAttrKey)
(define leading-key 'leading)
(: leading-key-default (Parameterof Float))
...
(: quality-key-default (Parameterof Index))
